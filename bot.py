...
MODEL = "gpt-5.6"
BOT_VERSION = "v7.9.5-clean-closeout"
...
def reconcile_closeout_state(chat_id):
    """
    Normalize the known current state after closeout so /tasks, /questions and
    the gift process do not contradict each other.
    """
...
def main():
    init_db()
    print(f"Masha 2.0 {BOT_VERSION} запущена: clean closeout + named gift artworks + pretty MS update + stale-task cleanup.")
    offset = None
    known_chat_ids = set()
